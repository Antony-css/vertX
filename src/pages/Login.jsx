...
export const Login = () => {
  ...
  return (
    <main className="bg-black text-white font-f2 min-h-screen flex flex-col overflow-hidden">
      <title>vertX - Login</title>
      <div className="flex-grow flex items-center justify-center px-4 py-6">
        <div className="login-container w-full max-w-4xl h-[90vh] md:h-[85vh] flex flex-col md:flex-row rounded-2xl overflow-hidden shadow-2xl border border-gray-800">
          {/* Left side - Login Section */}
          <div className="w-full md:w-1/2 bg-black p-6 md:p-8 flex flex-col justify-center border-r border-gray-800 overflow-hidden">
            ...
            <div className="text-center mb-6">
              <h1 className="text-xl md:text-3xl font-bold mb-2">Welcome Back</h1>
            </div>
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="form-element flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="remember" className="ml-2 text-xs md:text-sm">Remember me</label>
                </div>
                <a href="#" className="text-xs md:text-sm text-white hover:text-gray-300 transition">Forgot password?</a>
              </div>
            ...
            <div className="mt-6">
              ...
              <div className="mt-4 grid grid-cols-2 gap-2 social-login">
                <button className="form-element w-full inline-flex justify-center py-2 px-4 border border-gray-700 rounded-md shadow-sm bg-gray-900 text-xs md:text-sm font-medium text-white hover:bg-gray-800 transition-all duration-300 transform hover:scale-105">
                  <i className="fab fa-google text-lg"></i>
                  <span className="ml-2 mt-1">Google</span>
                </button>
                
                <button className="form-element w-full inline-flex justify-center py-2 px-4 border border-gray-700 rounded-md shadow-sm bg-gray-900 text-xs md:text-sm font-medium text-white hover:bg-gray-800 transition-all duration-300 transform hover:scale-105">
                  <i className="fab fa-microsoft text-lg"></i>
                  <span className="ml-2 mt-1">Microsoft</span>
                </button>
              </div>
            </div>
            ...
            <div className="mt-6 text-center">
              <p className="text-xs md:text-sm text-gray-400">
                ...
                <a href="/register" className="font-medium text-white hover:text-gray-300 transition">
                  Register here
                </a>
              </p>
            </div>
          ...
          <div className="w-full md:w-1/2 relative overflow-hidden hidden md:block image-section">
            <div className="absolute inset-0 bg-gradient-to-bl from-gray-900 to-black"></div>
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center p-6 md:p-8">
                ...
                <h2 className="text-xl md:text-2xl font-bold text-white mb-3 md:mb-4">Developer First</h2>
                <p className="text-gray-400 text-xs md:text-sm max-w-md mx-auto">
                  Join our community of passionate developers building the future
                </p>
              </div>
            </div>
          </div>
